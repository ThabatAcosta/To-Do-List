...
const Card = ({title, completed, id, handleClick}) => {
    ...
    return (
        <div className=' w-11/12 bg-gradient-to-r from-green-200 via-green-400 to-green-200 flex flex-col  p-2 border-gray-500 border-2 rounded-xl justify-around  items-center space-y-2  ' style={ {minHeight:'10rem' } }>
